...
let aliyot = [
  { aliyah: 'כהן', leiner: 'Rafi Strauss' },
  { aliyah: 'לוי', leiner: 'Rafi Strauss' },
  { aliyah: 'שלישי', leiner: 'Yoni Friedman' },
  { aliyah: 'רביעי', leiner: 'Daniel Blau' },
  { aliyah: 'חמישי', leiner: 'Daniel Blau' },
  { aliyah: 'שישי', leiner: 'Rafi Lefkowitz' },
