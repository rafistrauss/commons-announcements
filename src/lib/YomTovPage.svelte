      ...
      <section class="day-block" class:erev-block={day.isErev} class:shabbat-block={day.isShabbat}>
        ...
        <div class="times-grid">
          <section class="day-section">
            ...
            {#if !day.isErev}
              {#if day.noShacharit}
                <div class="time-item no-minyan">
                  <span class="time-label">Shacharit:</span>
                  <span class="no-minyan-message">No Minyan</span>
                </div>
            ...
            <!-- Mincha / Maariv combined -->
            {#if day.noMinchaAndMaariv}
              <div class="time-item no-minyan">
            ...
            {:else}
              ...
              {:else if day.mincha}
                ...
                {/if}
                {#if !day.isErev && day.minchaNotices.omissions.length > 0}
                  <div class="liturgical-notice omissions">
